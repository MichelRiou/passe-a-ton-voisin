 ...
 */
class Version20180302140542 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, category_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, message_text LONGTEXT NOT NULL COLLATE utf8_unicode_ci, closed TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_B6BD307F2B36786B (title), INDEX IDX_B6BD307FF675F31B (author_id), INDEX IDX_B6BD307F12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
